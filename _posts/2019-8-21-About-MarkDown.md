...
subtitle:  An article about Markdown.
...
每个单元格之间用竖斜杠表示分割的,冒号是用来控制对齐方式的，在短横杠的左边添加冒号表示左对齐，两边都添加冒号表示居中，右边添加冒号表示右对齐
...
多行代码: 使用三个反引号将代码块包裹，并且三个反引号单独占一行。

tip：反引号一般位于键盘的tab上面一个键。
